...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (haml-mode yaml-mode web-mode stylus-mode ssh-config-mode ruby-end rspec-mode python-mode markdown-mode magit jscs js2-mode gitconfig-mode flycheck auto-complete apache-mode))))
(custom-set-faces
