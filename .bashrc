...
alias allTheThings="brew update && brew upgrade && brew cleanup && brew cask cleanup && yarn global upgrade && brew-cask-outdated && osascript -e 'display notification \"Done with all the things.\" with title \"Bash\" sound name \"Submarine\"'"
