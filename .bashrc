...
alias allTheThings="brew update && brew upgrade && brew cleanup && brew outdated --cask --version && osascript -e 'display notification \"Done with all the things.\" with title \"Bash\" sound name \"Submarine\"'"
